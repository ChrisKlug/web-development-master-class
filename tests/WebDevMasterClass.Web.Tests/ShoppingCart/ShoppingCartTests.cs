...
public class ShoppingCartTests
{
    ...
    public class AddShoppingCartItem
    {
        ...
        public async Task Adds_item_to_grain_with_random_id_if_no_cookie_exists()
        {
            ...
            productsClient =>
            {
                A.CallTo(() => productsClient.GetProduct(1)).Returns(new Product(1, "Test Product", "A Test Product", 1.23m));
            });
        ...
        var app = new WebApplicationFactory<Program>()
                        .WithWebHostBuilder(builder =>
                        {
                            ...
                            builder.ConfigureTestServices(services =>
                            {
                                ...
                                var productsClient = A.Fake<IProductsClient>();
                                configureProductsClient?.Invoke(productsClient);
