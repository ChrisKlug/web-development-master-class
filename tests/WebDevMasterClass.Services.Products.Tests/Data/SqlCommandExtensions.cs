...
public static class SqlCommandExtensions
{
    public static async Task<int> AddProduct(this SqlCommand cmd, 
                                        ...
                                        string imageName)
	{
		cmd.CommandText = "INSERT INTO Products (Name, Description, Price, IsFeatured, ThumbnailUrl, ImageUrl) VALUES (@Name, @Description, @Price, @IsFeatured, @ThumbnailUrl, @ImageUrl); SELECT SCOPE_IDENTITY();";
